...
<body>
    ...
    <div class="carrossel" id="carrossel">
      <div class="carrossel-track" id="carrosselTrack">
        <img class="carrossel-img" src="../Imagens/carrossel/cachoira_rio_grande.JPG" alt="Cachoeira em Rio Grande da Serra">
        <img class="carrossel-img" src="../Imagens/carrossel/letreiro.jpg" alt="Letreiro de boas-vindas a Rio Grande da Serra">
        <img class="carrossel-img" src="../Imagens/carrossel/cachoeira_2.jpg" alt="Cachoeira em Rio Grande da Serra">
      </div>
    </div>
  </div>
